...
function importTypes(ary) {
    ...
    Object.entries(require('../type/media.js')).forEach(([name, imported]) => ary[name] = imported);
    Object.entries(require('../type/member-chat-message.js')).forEach(([name, imported]) => ary[name] = imported);
    Object.entries(require('../type/member.js')).forEach(([name, imported]) => ary[name] = imported);
    Object.entries(require('../type/date-change-message.js')).forEach(([name, imported]) => ary[name] = imported);
    Object.entries(require('../type/message-parser.js')).forEach(([name, imported]) => ary[name] = imported);
    Object.entries(require('../type/message.js')).forEach(([name, imported]) => ary[name] = imported);
